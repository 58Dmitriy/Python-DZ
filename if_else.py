...
age_2 = abs(int(input("Введите числом ваш возраст: ")))
print("Укажите желаемое время посещения сеанса в формате от 0 до 24 часов")
session_time = abs(int(input("Введите желаемое время посещения сеанса: ")))
price = 0
discount = 0
full_price = 0
...
if age_2 < 3:
    print("Посещение сеанса детям до 3-х лет бесплатно")
else:
    print(f"Стоимость посещения сеанса составит {full_price}$")
